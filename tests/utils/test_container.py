...
def test_container_factory():
    ...
    container.register(TestService, name="custom", factory=custom_factory)
...
def test_container_dependencies():
    ...
    container.register(DependentService, dependencies={"test_service": "TestService"})
...
def test_container_error_handling():
    ...
    # Missing dependency
    container.register(DependentService, dependencies={"test_service": "NonExistent"})
