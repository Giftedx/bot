...
API_CONFIG = {
    'discord': {
        ...
        'required_scopes': [
            'identify', 'guilds', 'voice', 
            'activities.write', 'rpc', 
...
GAME_DATA_SOURCES = {
    'pokemon': {
        'games': [
            ...
            {'name': 'Gold/Silver', 'platform': 'gbc', 'parser': 'gbc_parser', 'repo': 'pret/pokegold'},
            {'name': 'Crystal', 'platform': 'gbc', 'parser': 'gbc_parser', 'repo': 'pret/pokecrystal'},
            {'name': 'Ruby/Sapphire', 'platform': 'gba', 'parser': 'gba_parser', 'repo': 'pret/pokeruby'},
            {'name': 'Emerald', 'platform': 'gba', 'parser': 'gba_parser', 'repo': 'pret/pokeemerald'},
            {'name': 'FireRed/LeafGreen', 'platform': 'gba', 'parser': 'gba_parser', 'repo': 'pret/pokefirered'}
        ],
        'data_sources': [
    ...
    'osrs': {
        'data_types': [
            'items', 'monsters', 'quests', 'locations', 'ge_prices',
            'hiscores', 'player_stats', 'clan_data'
        ],
        'sources': [
            'osrsbox-db', 'runelite-data', 'wiki-data', 'ge-tracker'
        ],
        'tools': [
