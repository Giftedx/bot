...
class MinigameManager:
    ...
    def _load_requirements(self) -> Dict[MinigameType, MinigameRequirements]:
        ...
        return {
            MinigameType.PEST_CONTROL: MinigameRequirements(
                combat_level=40
            ),
            MinigameType.BARBARIAN_ASSAULT: MinigameRequirements(
                combat_level=20,
                team_size=4
            ),
            ...
            MinigameType.FISHING_TRAWLER: MinigameRequirements(
                skill_requirements={"fishing": 15}
            ),
            MinigameType.VOLCANIC_MINE: MinigameRequirements(
                skill_requirements={"mining": 50}
            ),
            MinigameType.TEMPOROSS: MinigameRequirements(
            ...
            MinigameType.SOUL_WARS: MinigameRequirements(
                combat_level=40
            )
        }
