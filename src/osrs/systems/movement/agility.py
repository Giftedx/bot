...
class AgilityManager:
    ...
    def __init__(self):
        ...
        self.active_laps: Dict[str, Tuple[str, datetime, int]] = {}  # player_id -> (course, start_time, obstacle_index)
    ...
    async def attempt_obstacle(
        ...
        if obstacle_index >= len(course.obstacles):
            ...
            return None, course.reward.completion_bonus, f"You complete the {course_name} Agility Course!"
    ...
    async def use_shortcut(
        ...
        if from_location != shortcut.start_location:
            if shortcut.bidirectional and from_location == shortcut.end_location:
                ...
                shortcut.start_location, shortcut.end_location = shortcut.end_location, shortcut.start_location
            else:
        ...
        if player_agility < reqs.agility_level:
            return None, None, None, f"You need level {reqs.agility_level} Agility to use this shortcut!"
        ...
        return shortcut.end_location, None, obstacle.reward.experience, f"You successfully use the {shortcut_name}"
