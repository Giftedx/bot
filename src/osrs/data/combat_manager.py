...
class CombatManager(DataManager):
    ...
    def calculate_combat_level(self, stats: Dict[str, int]) -> int:
        ...
        base = math.floor((stats["defence"] + stats["hitpoints"] + 
                          math.floor(stats["prayer"] / 2)) / 4)
    ...
    def calculate_damage_reduction(self,
        ...
        defense_reduction = (math.floor(defense_level * 0.3) +
                           math.floor(armor_bonus * 0.7)) / 100
