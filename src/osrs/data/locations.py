...
MAJOR_CITIES = [
    Location(
        name="Lumbridge",
        area=WorldArea(3218, 3218, 30, 30),
        region=MapRegion.MISTHALIN
    ),
    Location(
        name="Varrock",
        area=WorldArea(3210, 3424, 40, 40),
        region=MapRegion.MISTHALIN
    ),
    Location(
        name="Falador",
        area=WorldArea(2944, 3368, 35, 35),
        region=MapRegion.ASGARNIA
    ),
    Location(
        name="Ardougne",
...
TRAINING_AREAS = [
    Location(
        name="Cow Field",
        area=WorldArea(3242, 3291, 15, 15),
        region=MapRegion.MISTHALIN
    ),
    Location(
        name="Barbarian Village",
        area=WorldArea(3072, 3420, 20, 20),
        region=MapRegion.MISTHALIN
    ),
    Location(
        name="Al Kharid Warriors",
        area=WorldArea(3293, 3169, 15, 15),
        region=MapRegion.MISTHALIN
    )
]
...
SKILLING_LOCATIONS = [
    ...
    Location(
        ...
        area=WorldArea(3280, 3360, 15, 15),
        region=MapRegion.MISTHALIN
    ),
    Location(
        name="Varrock West Mine",
        area=WorldArea(3172, 3368, 15, 15),
        region=MapRegion.MISTHALIN
    ),
    # Fishing
    Location(
        name="Draynor Fishing Spot",
        area=WorldArea(3084, 3227, 10, 10),
        region=MapRegion.MISTHALIN
    ),
    # Woodcutting
    Location(
        name="Draynor Willows",
        area=WorldArea(3084, 3238, 12, 12),
        region=MapRegion.MISTHALIN
    )
]
...
MINIGAME_LOCATIONS = [
    Location(
        name="Duel Arena",
        area=WorldArea(3355, 3265, 40, 40),
        region=MapRegion.MISTHALIN
    ),
    Location(
        name="Castle Wars",
...
WILDERNESS_LOCATIONS = [
    Location(
        name="Edgeville Wilderness",
        area=WorldArea(3091, 3498, 30, 30),
...
SHIP_ROUTES: List[TransportLocation] = [
    TransportLocation(
        ...
        x=3029, y=3218, plane=0,
        destination_x=2955, destination_y=3144,
        members_only=False
    ),
    TransportLocation(
        id=2,
        ...
        transport_type=TransportationType.SHIP,
        x=3046, y=3233, plane=0,
        destination_x=2833, destination_y=3334,
        members_only=False
    ),
...
MINECART_STATIONS: List[TransportLocation] = [
    TransportLocation(
        ...
        x=3139, y=3504, plane=0,
        destination_x=2908, destination_y=10170,
        members_only=True
    ),
