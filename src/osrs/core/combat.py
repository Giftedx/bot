...
class CombatSystem:
    ...
    def calculate_accuracy(self,
                         ...
                         style: CombatStyle,
                         attack_type: AttackType,
                         prayer_multiplier: float = 1.0) -> float:
        ...
        defence_equipment = (defender_equipment.defence_stab if attack_type == AttackType.MELEE else
                           defender_equipment.defence_ranged if attack_type == AttackType.RANGED else
                           defender_equipment.defence_magic)
    ...
    def process_hit(self,
                   ...
                   attack_type: AttackType,
                   prayer_multiplier: float = 1.0,
                   other_bonus: float = 1.0) -> Tuple[bool, int]:
        ...
        accuracy = self.calculate_accuracy(
            attacker, defender,
            attacker_equipment, defender_equipment,
            style, attack_type, prayer_multiplier
        )
