...
class QuestManager:
    ...
    def __init__(self, game_tick: GameTick):
        ...
        self.player_progress: Dict[int, Dict[str, QuestStatus]] = {}  # player_id: {quest_id: status}
    ...
    def get_quest_status(self,
        ...
        Returns:
            Quest status
        """
        return self.player_progress.get(player_id, {}).get(
            quest_id,
    ...
    def can_start_quest(self,
        ...
        # Check quest points
        if (quest.requirements.quest_points and 
            quest_points < quest.requirements.quest_points):
            return (False, f"Requires {quest.requirements.quest_points} quest points")
            
        # Check combat level
        if (quest.requirements.combat_level and 
            self._calculate_combat_level(player_stats) < quest.requirements.combat_level):
