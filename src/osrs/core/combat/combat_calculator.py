...
class CombatCalculator:
    ...
    def calculate_accuracy(
        attack_level: int, equipment_bonus: int, prayer_bonus: float = 1.0, other_bonus: float = 1.0
    ) -> float:
    ...
    @staticmethod
    def calculate_hit_chance(attack_roll: float, defence_roll: float) -> float:
    ...
    @staticmethod
    def calculate_dps(max_hit: int, accuracy: float, attack_speed: float) -> float:
