...
class PetManager:
    ...
    def __init__(self, game_tick: GameTick):
        ...
        self.game_tick.register_task("pet_update", self._pet_tick, TickPriority.WORLD)
    ...
    def _initialize_pets(self):
        ...
        self.pets["rock_golem"] = PetData(
            ...
            dialogue=["Ready to mine?", "Found any good rocks lately?"],
        )
        ...
        self.pets["beaver"] = PetData(
            ...
            dialogue=["How much wood could a woodchuck chuck?", "Nice trees around here!"],
        )
        ...
        self.pets["prince_black_dragon"] = PetData(
            ...
            dialogue=["Rawr!", "When do I get to be king?"],
        )
    ...
    def _apply_threshold(self, base_chance: float, kill_count: int, threshold: int) -> float:
    ...
    def add_pet(self, player_id: int, pet_id: str, auto_insure: bool = False) -> bool:
        ...
        # Create pet instance
        pet = Pet(
            data=self.pets[pet_id], obtained_at=self.game_tick.get_tick_count(), insured=auto_insure
        )
    ...
    def has_pet(self, player_id: int, pet_id: str) -> bool:
        ...
        """
        return (
            player_id in self.player_pets
            and pet_id in self.player_pets[player_id]
            and not self.player_pets[player_id][pet_id].lost
        )
    ...
    def set_active_pet(self, player_id: int, pet_id: Optional[str] = None) -> bool:
    ...
    def get_player_pets(self, player_id: int) -> List[Pet]:
        ...
        return [pet for pet in self.player_pets[player_id].values() if not pet.lost]
    ...
    def get_lost_pets(self, player_id: int) -> List[Pet]:
        ...
        return [pet for pet in self.player_pets[player_id].values() if pet.lost]
