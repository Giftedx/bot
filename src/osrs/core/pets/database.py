...
class PetDatabase:
    ...
    async def save_battle(self, battle_id: str, pet1_id: str, pet2_id: str,
                         winner_id: str, turns: int, battle_log: List[Dict[str, Any]]) -> None:
    ...
    async def save_breeding(self, breeding_id: str, parent1_id: str, parent2_id: str,
                          success: bool, started_at: datetime,
    ...
    async def get_battle_history(self, pet_id: Optional[str] = None,
    ...
    async def get_breeding_history(self, pet_id: Optional[str] = None,
                                 limit: int = 10) -> List[Dict[str, Any]]:
