...
class PetService:
    ...
    async def create_pet(self, owner_id: str, name: str, origin: PetOrigin,
                        rarity: PetRarity = PetRarity.COMMON) -> BasePet:
        """Create a new pet."""
        # Create pet instance
        pet = BasePet(
            id=str(uuid.uuid4()),
    ...
    async def process_battle_turn(self, battle_id: str, pet_id: str,
