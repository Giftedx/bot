...
class BattleSystem:
    ...
    def __init__(self):
        ...
        self.status_effects = {
            ...
            "weakness": {
                "stat_mod": {"attack": 0.75},
                "turns": 2
            },
            "vulnerable": {
                "stat_mod": {"defense": 0.75},
                "turns": 2
            }
        }
    ...
    def _calculate_damage(self, move: BattleMove, attacker: BattlePet, defender: BattlePet) -> Tuple[int, str]:
        ...
        if move.status_effect and random.randint(1, 100) <= move.status_chance:
            if move.status_effect.value in self.status_effects:
                defender.status_effects[move.status_effect.value] = self.status_effects[move.status_effect.value].copy()
    ...
    def get_available_moves(self, battle_id: str, pet_id: str) -> List[str]:
        ...
        return [
            move.name for move in pet.moves
