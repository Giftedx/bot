...
class MinigameManager:
    ...
    def __init__(self, game_tick: GameTick):
        ...
        self.game_tick.register_task("minigame_update", self._minigame_tick, TickPriority.WORLD)
    ...
    def start_minigame(self, minigame_id: str, players: Set[int]) -> Optional[str]:
    ...
    def end_minigame(self, instance_id: str, status: MinigameStatus = MinigameStatus.COMPLETED):
    ...
    def _award_points(self, player_id: int, minigame_id: str, points: int):
    ...
    def _award_rewards(self, player_id: int, minigame: Minigame, points: int):
    ...
    def get_player_points(self, player_id: int, minigame_id: Optional[str] = None) -> int:
