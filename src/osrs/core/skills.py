...
class SkillSystem:
    ...
    def calculate_mining_success(self, level: int, rock_level: int, pickaxe_bonus: int) -> float:
    ...
    def calculate_woodcutting_success(self, level: int, tree_level: int, axe_bonus: int) -> float:
    ...
    def calculate_fishing_success(self, level: int, spot_level: int, tool_bonus: int) -> float:
    ...
    def calculate_thieving_success(
        self, level: int, target_level: int, glove_bonus: int = 0
    ) -> float:
    ...
    def calculate_agility_success(self, level: int, obstacle_level: int) -> float:
    ...
    def calculate_crafting_speed(self, level: int, item_level: int) -> float:
    ...
    def calculate_cooking_success(
        self, level: int, food_level: int, gauntlets_bonus: bool = False
    ) -> float:
    ...
    def calculate_herblore_success(self, level: int, potion_level: int) -> float:
    ...
    def calculate_fletching_speed(self, level: int, item_level: int) -> float:
    ...
    def calculate_smithing_speed(self, level: int, item_level: int) -> float:
    ...
    def calculate_runecraft_multiplier(self, level: int, rune_level: int) -> int:
