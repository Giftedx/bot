...
class WorldPoint:
    ...
    def is_in_scene(self, scene_base_x: int, scene_base_y: int) -> bool:
        ...
        return (
            self.x >= scene_base_x and self.x < max_x and self.y >= scene_base_y and self.y < max_y
        )
...
class WorldMap:
    ...
    def _initialize_regions(self):
        ...
        self._add_region_coords(
            MapRegion.ASGARNIA,
            [(11828, 11829), (11572, 11573), (11316, 11317)],  # Falador  # Port Sarim  # Rimmington
        )
    ...
    def get_locations_in_area(self, area: WorldArea) -> List[Location]:
        ...
        return [loc for loc in self.locations.values() if loc.area.overlaps(area)]
