...
class SkillingManager:
    ...
    def attempt_gather(self, 
                      ...
                      skill_manager: SkillManager) -> Tuple[bool, float]:
        """
    ...
    def _get_skill_for_resource(self, resource_type: ResourceType) -> Optional[SkillType]:
        ...
        elif resource_type in [ResourceType.SHRIMP, ResourceType.SARDINE, 
                             ResourceType.HERRING, ResourceType.TROUT,
                             ResourceType.SALMON, ResourceType.LOBSTER,
                             ResourceType.SWORDFISH, ResourceType.SHARK]:
