...
class ResourceManager:
    ...
    def __init__(self, game_tick: GameTick):
        ...
        self.game_tick.register_task("resource_update", self._resource_tick, TickPriority.WORLD)
    ...
    def start_gathering(self, player_id: int, resource_id: str) -> Tuple[bool, Optional[str]]:
    ...
    def stop_gathering(self, player_id: int, resource_id: str):
    ...
    def attempt_gather(self, player_id: int, resource_id: str) -> Tuple[bool, Optional[str]]:
    ...
    def get_resources_in_range(self, position: Position, max_distance: float) -> List[Resource]:
    ...
    def get_nearest_resource(
        self, position: Position, resource_type: Optional[ResourceType] = None
    ) -> Optional[Resource]:
        ...
        return min(resources, key=lambda r: r.position.real_distance_to(position))
