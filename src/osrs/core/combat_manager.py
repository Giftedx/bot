...
class CombatManager:
    ...
    PRAYERS = {
        ...
        "piety": PrayerBonus("Piety", attack_multiplier=1.20, strength_multiplier=1.23, defence_multiplier=1.25),
        # Ranged prayers
        ...
        "rigour": PrayerBonus("Rigour", attack_multiplier=1.20, strength_multiplier=1.23, defence_multiplier=1.25),
        # Magic prayers
        ...
        "mystic_might": PrayerBonus("Mystic Might", attack_multiplier=1.15, strength_multiplier=1.15),
    ...
    def calculate_max_hit(self,
                         stats: CombatStats,
                         bonuses: CombatBonuses,
                         style: CombatStyle,
                         attack_type: AttackType,
                         prayer_bonus: Optional[PrayerBonus] = None,
                         void_bonus: bool = False) -> int:
        ...
        if attack_type in (AttackType.STAB, AttackType.SLASH, AttackType.CRUSH):
            ...
            # Apply prayer bonus
            if prayer_bonus:
                effective_strength = math.floor(effective_strength * prayer_bonus.strength_multiplier)
    ...
    def calculate_accuracy(self,
        ...
        defence_equipment = (
            defender_bonuses.defence_stab if attack_type == AttackType.STAB else
            defender_bonuses.defence_slash if attack_type == AttackType.SLASH else
            defender_bonuses.defence_crush if attack_type == AttackType.CRUSH else
            defender_bonuses.defence_ranged if attack_type == AttackType.RANGED else
            defender_bonuses.defence_magic
        )
    ...
    def calculate_damage(self,
                        max_hit: int,
                        accuracy: float,
                        prayer_reduction: float = 0.0) -> int:
    ...
    def calculate_dps(self,
        ...
        max_hit = self.calculate_max_hit(
            attacker, attacker_bonuses,
            style, attack_type,
            prayer_bonus, void_bonus
        )
