...
class ConsumableDatabase:
    ...
    FOOD = {
        ...
        'pike': ConsumableItem(
            name='Pike',
            effect=ConsumableEffect(heal=8, cooldown=1.8),
            description='A long fish.'
        ),
        ...
        'tuna': ConsumableItem(
            name='Tuna',
            effect=ConsumableEffect(heal=10, cooldown=1.8),
            description='A big fish.'
        ),
        ...
        'bass': ConsumableItem(
            name='Bass',
            effect=ConsumableEffect(heal=13, cooldown=1.8),
            description='A tasty fish.'
        ),
        ...
        'karambwan': ConsumableItem(
            ...
            effect=ConsumableEffect(
                heal=18,
                cooldown=0.6,  # Reduced cooldown
                combo_food=True  # Can be combo eaten
            ),
        ...
        'anglerfish': ConsumableItem(
            ...
            effect=ConsumableEffect(
                heal=22,
                cooldown=1.8,
                special_effects={'overheal'}  # Can heal above max HP
            ),
    ...
    def consume_potion(self, name: str) -> Optional[ConsumableEffect]:
        ...
        if effect.duration > 0:
            ...
            if effect.special_effects and 'divine' in effect.special_effects:
                ...
                self.active_effects = {
                    name: effect for name, effect in self.active_effects.items()
