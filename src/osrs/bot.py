...
async def custom_help(ctx):
    ...
    embed = discord.Embed(
        ...
        description='All commands use the prefix !osrs',
        color=0x00ff00
    )
    ...
    commands_list = {
        'Combat': {
            ...
            'maxhit <base_level> <effective_level> <strength_bonus> [void]': 
                'Calculate max hit',
            'accuracy <attack_level> <equipment_bonus> <defence_level> <defence_bonus>': 
                'Calculate hit chance',
            'spec <weapon>': 'Show special attack information',
            'potion <potion_name> <base_level>': 'Calculate potion boost effects'
        },
        'Equipment': {
            'equipment <item_name>': 'Show detailed equipment stats and requirements'
        },
        'Skills': {
        ...
        'Items': {
            'droprate <base_chance> [ring_of_wealth] [kill_count]': 
                'Calculate drop rates and pet chances'
        },
        'Movement': {
            'runenergy <weight> <agility_level>': 
        ...
        'Bosses': {
            ...
            'cox [boss] [team_size] [points] [personal_points] [challenge_mode]': 
                'Show Chambers of Xeric information',
            'tob [boss] [team_size] [deaths] [completion_time]': 
        ...
        'PvP': {
            'wild [combat_level] [wilderness_level] [skull_type]': 
        ...
        'Clue Scrolls': {
            'clue [type] [step_type]': 'Show Clue Scroll information and rewards'
        },
        'Utility': {
