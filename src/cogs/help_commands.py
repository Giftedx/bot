    ...
    async def help_command(self, ctx, command_name: str = None):
        ...
        if command_name is None:
            ...
            if command_name == "combat":
                ...
                embed.add_field(name="!attack [monster]", value="Attack a monster", inline=False)
                embed.add_field(name="!equip [item]", value="Equip an item", inline=False)
                embed.add_field(name="!gear", value="View your current gear", inline=False)
                ...
                embed.add_field(name="!stats", value="View your stats", inline=False)
                embed.add_field(name="!highscores", value="View the highscores", inline=False)
                ...
                embed.add_field(name="!train [skill]", value="Train a skill", inline=False)
                embed.add_field(
                    name="!level [skill]", value="View your level in a skill", inline=False
                )
                ...
                embed.add_field(name="!quests", value="View available quests", inline=False)
                embed.add_field(name="!start [quest]", value="Start a quest", inline=False)
                ...
                embed.add_field(name="!pets", value="View your pets", inline=False)
                embed.add_field(
                    name="!pet [name]", value="View details about a specific pet", inline=False
                )
