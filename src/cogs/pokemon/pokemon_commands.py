...
class PokemonCommands(commands.Cog):
    ...
    @commands.hybrid_group(
        ...
        help="Pokemon Adventure System: Catch, train, and battle Pokemon!",
    )
    ...
    @pokemon.hybrid_command(
        name="catch", help="Try to catch a wild Pokemon. Usage: /pokemon catch <name>"
    )
    ...
    @pokemon.hybrid_command(
        name="info", help="View details about a specific Pokemon. Usage: /pokemon info <name>"
    )
    ...
    @pokemon.hybrid_command(
        name="release",
        help="Release a Pokemon from your collection. Usage: /pokemon release <name>",
    )
    ...
    @pokemon.hybrid_command(
        name="battle",
        help="Challenge another trainer to a Pokemon battle. Usage: /pokemon battle @user",
    )
    ...
    @pokemon.hybrid_command(
        name="move", help="Use a move in a Pokemon battle. Usage: /pokemon move <name>"
    )
    ...
    @pokemon.hybrid_command(
        name="switch", help="Switch your active Pokemon in battle. Usage: /pokemon switch <name>"
    )
    ...
    @pokemon.hybrid_command(
        name="train", help="Train your Pokemon to make it stronger. Usage: /pokemon train <name>"
    )
    ...
    @pokemon.hybrid_command(
        name="evolve",
        help="Evolve your Pokemon if it meets the requirements. Usage: /pokemon evolve <name>",
    )
    ...
    @pokemon.hybrid_command(
        name="stats", help="View your Pokemon's training progress. Usage: /pokemon stats <name>"
    )
    ...
    @pokemon.hybrid_command(
        name="moves", help="View or manage your Pokemon's moves. Usage: /pokemon moves <name>"
    )
