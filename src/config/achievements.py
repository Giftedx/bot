...
class AchievementConfig:
    def __init__(self):
        self.achievements = {
            ...
            "catch_all_starters": Achievement(
                ...
                requirements={"pokemon_species": ["Charmander", "Bulbasaur", "Pikachu"]},
                rewards={
            ...
            "max_combat": Achievement(
                ...
                requirements={"osrs_combat_level": 99},
                rewards={
            ...
            "evolution_master": Achievement(
                ...
                type=AchievementType.TRAINING,
                requirements={"pokemon_evolutions": 3},
                rewards={
            ...
            "hybrid_trainer": Achievement(
                ...
                requirements={"osrs_pet_level": 50, "pokemon_level": 50},
                rewards={
            ...
            "rare_collector": Achievement(
                ...
                type=AchievementType.CROSS_SYSTEM,
                requirements={"rare_pets": 3, "min_rarity": "rare"},
                rewards={
            ...
            "perfect_trainer": Achievement(
                ...
                requirements={"max_stat_pokemon": True, "max_level_osrs": True},
                rewards={
            ...
            "milestone_master": Achievement(
                ...
                type=AchievementType.SPECIAL,
                requirements={"total_boss_kills": 1000, "total_evolutions": 10},
                rewards={
    ...
    def check_achievement_completion(
        self, achievement: Achievement, user_data: Dict[str, Any]
    ) -> bool:
