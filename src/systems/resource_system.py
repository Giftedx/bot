...
class ResourceSystem:
    ...
    def __init__(self, db: DatabaseManager, cache_url: str, xp_system: XPSystem):
    ...
    async def harvest_resource(
        ...
        try:
            ...
            await self.xp_system.award_xp(
                player_id, ActivityType.COLLECTION, node.base_xp * success_modifier, metadata
            )
    ...
    async def _save_rewards(self, session, player_id: int, rewards: Dict[str, List[str]]) -> None:
