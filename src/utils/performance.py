...
METRICS = {
    "command_latency": Histogram(
        "command_latency_seconds", "Command execution latency in seconds", ["command_name"]
    ),
    "command_errors": Counter("bot_command_errors_total", "Command error count", ["command"]),
    "active_commands": Gauge("bot_active_commands", "Number of active commands"),
}
