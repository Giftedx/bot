...
class PlexActivity:
    ...
    def __init__(self, bot: commands.Bot, plex_url: str, plex_token: str):
        ...
        self.activity_config = {
            ...
            "activity_id": bot.config.get(
                "plex_activity_id", "1234567890"
            ),  # Replace with your actual Activity ID
            "supported_platforms": [
                "desktop",
                "web",
            ],  # Add 'mobile' if mobile support is implemented
            "activity_types": {"movie": 1, "show": 2, "music": 3},
        }
    ...
    async def initialize_activity(self, ctx: commands.Context) -> Optional[dict]:
        ...
        try:
            ...
            activity_config = {
                ...
                "party": {"id": str(voice_channel.id), "size": [1, voice_channel.user_limit or 99]},
                "secrets": {"join": self._generate_join_secret(voice_channel.id)},
                "instance": True,
            }
            ...
            self.active_activities[voice_channel.id] = {
                ...
                "current_media": None,
                "state": "INITIALIZED",
                "sdk_state": {"authorized": False, "authenticated": False, "access_token": None},
            }
    ...
    async def _update_activity_presence(self, channel_id: int):
        ...
        presence = {
            ...
            "timestamps": {"start": int(activity["start_time"])},
            "assets": {
    ...
    def _create_stream_url(self, media: Any) -> str:
        ...
        return media.getStreamURL(
            videoQuality="1080p", audioQuality="high", maxAudioChannels=2, videoBitrate="4mbps"
        )
