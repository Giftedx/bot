...
class Admin(commands.Cog):
    ...
    @commands.hybrid_group(name="config", invoke_without_command=True, help="Server configuration commands (admin only)")
    ...
    @config.hybrid_command(name="prefix", help="Change the bot's prefix for this server (admin only)")
    ...
    @commands.hybrid_group(name="cmd", invoke_without_command=True, help="Custom command management (admin only)")
    @commands.has_permissions(administrator=True)
    ...
    @app_commands.describe(name="Name of the custom command", response="Response text for the command")
    @commands.has_permissions(administrator=True)
    ...
    @commands.has_permissions(administrator=True)
    async def welcome(self, ctx: commands.Context, channel: Optional[discord.TextChannel] = None, *, message: Optional[str] = None):
    ...
    @commands.hybrid_command(name="autorole", help="Set up or view the autorole for new members (admin only)")
    ...
    @commands.hybrid_command(name="restore", help="Restore server settings from a backup (admin only)")
    @commands.has_permissions(administrator=True)
