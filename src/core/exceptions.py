...
class DatabaseError(BattleSystemError): # Note: Was BattleSystemError, could be a more general DB error too.
    """Raised when database operation fails."""
    pass

class ValidationError(BattleSystemError): # Note: Was BattleSystemError, could be a more general Validation error.
